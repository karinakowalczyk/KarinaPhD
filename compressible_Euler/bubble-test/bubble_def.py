...
delT = conditional(Lr > 1., 0., -7.5*(1.+cos(pi*Lr)))

'''if Lr(x,z) >1:
    return 0 
else:
    return -15*(cos(pi*Lr(x,z)+1)/2)
'''
...
name2 = "../../../Results/compEuler/bubble/deformed/perturbations/euler"
...
name = "../../../Results/compEuler/bubble/deformed/full/euler"
file_gw = File(name+'.pvd')
file_gw.write(un, rhon, thetan, lambdarn)
