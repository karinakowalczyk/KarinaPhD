...
compressible_hydrostatic_balance_with_correct_pi_top(mesh, vertical_degree, horizontal_degree,parameters, theta_b, rho_b, lambdar_b, Pi)
...
name = "../../Results/compEuler/mountain-test/mountain"
